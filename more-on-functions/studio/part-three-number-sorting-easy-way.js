...
let numArray = [nums1, nums2, nums3];
...
numArray.forEach((num) => { num.sort((a, b) => {return a - b})});
...
numArray.forEach((num) => { num.sort((a, b) => {return b - a})});
console.log(numArray);
// console.log(nums1);
// console.log("Avove functions alter the origional arrays");
